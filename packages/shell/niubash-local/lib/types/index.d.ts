 ...
 * `niu.exe`.
 */
export function candidateNiubashPaths(env?: NodeJS.ProcessEnv, platform?: NodeJS.Platform): string[]
 ...
 * for PATH resolution.
 */
export function resolveNiubashPath(
  configured?: string,
 ...
 * model-friendly environment, and niubash-branded diagnostics.
 */
export class NiubashLocalExecutor extends PwshLocalExecutor {
  ...
  protected readonly diagnosticPrefix: 'niubash-local'

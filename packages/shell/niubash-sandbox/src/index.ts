 ...
 * renders.
 * @module @cmx666/dsh-niubash-sandbox
 */
...
import type { Config as LocalConfig } from '@cmx666/dsh-niubash-local'
...
export class SandboxNiubashExecutor extends NiubashLocalExecutor {
  static override inject = ['subprocess', 'sandbox', 'sandboxPolicy']

  // No own Config: the sandbox default (mode + workspaceRoot) moved to
  // ctx.sandboxPolicy, so this executor inherits NiubashLocalExecutor's Config
   ...
   * @param spec - resolved execution spec whose winuxsh argv is confined.
...
export default SandboxNiubashExecutor
